...
?>
				...
				<figure>
					<a href="javascript:void('');" title="<?php echo  lang_Select?>" class="link" data-file="<?php echo iconv('utf-8', 'windows-1251', $file); ?>" data-type="<?php echo $_GET['type']; ?>" data-field_id="<?php echo $_GET['field_id']; ?>" data-function="<?php echo $apply; ?>">
					<div class="img-precontainer">
					<div class="img-container"><span></span>
					<img data-src="holder.js/122x91" alt="image" <?php echo $show_original ? "class='original'" : "" ?> src="<?php echo iconv('utf-8', 'windows-1251', $src_thumb); ?>">
					</div>
					</div>
					<div class="img-container-mini <?php if($is_img) echo 'original-thumb' ?>">
					    <img alt="image" src="<?php echo iconv('utf-8', 'windows-1251', $mini_src); ?>">
					</div>
					</a>	
					<div class="box">				
					<h4><a href="javascript:void('');" title="<?php echo  lang_Select?>" class="link" data-file="<?php echo iconv('utf-8', 'windows-1251', $file); ?>" data-type="<?php echo $_GET['type']; ?>" data-field_id="<?php echo $_GET['field_id']; ?>" data-function="<?php echo $apply; ?>">
					<?php $filename=substr($file, 0, '-' . (strlen($file_ext) + 1)); echo iconv('utf-8', 'windows-1251', $filename); ?></a></h4>
					</div>
					<figcaption>
					    <form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
						<input type="hidden" name="path" value="<?php echo $root. $cur_dir. iconv('utf-8', 'windows-1251', $file)?>"/>
						<input type="hidden" name="name" value="<?php echo iconv('utf-8', 'windows-1251', $file)?>"/>
					    ...
					    <?php if($is_img){ ?>
					    <a class="tip-right preview" title="<?php echo lang_Preview?>" data-url="<?php echo iconv('utf-8', 'windows-1251', $src);?>" data-toggle="lightbox" href="#previewLightbox"><i class=" icon-eye-open"></i></a>
					    <?php }else{ ?>
					    <a class="preview disabled"><i class="icon-eye-open icon-white"></i></a>
					    <?php } ?>
					    <a href="javascript:void('');" class="tip-left edit-button <?php if($rename_files) echo "rename-file"; ?>" title="<?php echo lang_Rename?>" data-path="<?php echo $root. $cur_dir .iconv('utf-8', 'windows-1251', $file); ?>" data-thumb="<?php echo $thumbs_path.$subdir .iconv('utf-8', 'windows-1251', $file); ?>">
					    <i class="icon-pencil <?php if(!$rename_files) echo 'icon-white'; ?>"></i></a>
					    
					    <a href="javascript:void('');" class="tip-left erase-button <?php if($delete_files) echo "delete-file"; ?>" title="<?php echo lang_Erase?>" data-confirm="<?php echo lang_Confirm_del; ?>" data-path="<?php echo $root. $cur_dir .iconv('utf-8', 'windows-1251', $file); ?>" data-thumb="<?php echo $thumbs_path.$subdir .iconv('utf-8', 'windows-1251', $file); ?>">
