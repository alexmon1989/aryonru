...
$base_url="http://aryon.ru"; //url base of site if you want only relative url leave empty
$upload_dir = '/assets/img/uploads/'; // path from base_url to upload base dir
$current_path = '../../../../img/uploads/'; // relative path from filemanager folder to upload files folder
...
$ext_file = array('doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','psd','sql','log','fla','xml','ade','adp','ppt','pptx'); //Files
