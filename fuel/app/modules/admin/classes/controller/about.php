...
/**
 * Контроллер для управления данными на странице сайта "О компании"
 */
class Controller_About extends Controller_Base{
    ...
    {
        is_null($lang) and Response::redirect('admin/about/index');
        ...
        $article = \Model_Articles_I18n::query()
                ...
                ->where('article_parent.article_type.value', 'О компании')
        ...
        if ($val->run())
        {
            ...
            if ($article->save(FALSE))
            {
                ...
                \Response::redirect('admin/about/index/' . $lang);
            }
        ...
        $this->template->title = 'Страницы :: О компании';
